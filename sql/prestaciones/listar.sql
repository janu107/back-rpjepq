-- Prestaciones: listado de planillas de un tipo (5 Bono 14 / 7 Aguinaldo / 9 Bono Vacacional)
-- con totales calculados. Params: [tipoPlanilla, tipoPlanilla].
SELECT
...
LEFT JOIN (
  ...
  WHERE nin_id_tipo_planilla = ? AND nin_tipo_manejo = 1
