...
const bulkUpload = async (req, res, next) => { try { return successResponse(res, await service.bulkUpload(req.file?.buffer, req.user), "Carga masiva procesada correctamente", 201); } catch (error) { next(error); } };
