...
router.get("/", authorizeRoles("ADMIN", "OPERADOR", "CONSULTA"), aportacionesController.list);
router.get("/:id", authorizeRoles("ADMIN", "OPERADOR", "CONSULTA"), aportacionesController.getById);
...
router.get("/:id/detalle", authorizeRoles("ADMIN", "OPERADOR", "CONSULTA"), detalleController.listByAportacion);
...
router.get("/:id/total", authorizeRoles("ADMIN", "OPERADOR", "CONSULTA"), detalleController.getTotal);
