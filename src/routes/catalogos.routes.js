...
router.get("/:catalogo", authorizeRoles("ADMIN", "OPERADOR"), catalogosController.list);
router.get("/:catalogo/:id", authorizeRoles("ADMIN", "OPERADOR"), catalogosController.getById);
