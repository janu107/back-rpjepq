...
router.post("/calcular-cuota", authorizeRoles("ADMIN", "OPERADOR", "CONSULTA"), prestamosController.calculate);
router.get("/", authorizeRoles("ADMIN", "OPERADOR", "CONSULTA"), prestamosController.list);
router.get("/:id", authorizeRoles("ADMIN", "OPERADOR", "CONSULTA"), prestamosController.getById);
...
router.get("/:id/detalle", authorizeRoles("ADMIN", "OPERADOR", "CONSULTA"), detalleController.listByPrestamo);
...
router.get("/:id/saldo", authorizeRoles("ADMIN", "OPERADOR", "CONSULTA"), detalleController.getSaldo);
router.get("/:id/total-pagado", authorizeRoles("ADMIN", "OPERADOR", "CONSULTA"), detalleController.getTotalPagado);
